...
{
    /// <inheritdoc />
    public partial class init12june : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sku_import_sessions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodsNature = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ReferencePrice = table.Column<decimal>(type: "numeric", nullable: true),
                    IsValid = table.Column<bool>(type: "boolean", nullable: false),
                    ErrorCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ErrorMessage = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedSkuId = table.Column<Guid>(type: "uuid", nullable: true),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sku_import_rows", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_code_sequences_DeletedAt",
                table: "code_sequences",
                column: "DeletedAt");

            migrationBuilder.CreateIndex(
                name: "IX_code_sequences_IsDeleted",
                table: "code_sequences",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_code_sequences_Prefix",
                table: "code_sequences",
                column: "Prefix");

            migrationBuilder.CreateIndex(
                name: "IX_code_sequences_TenantId",
                table: "code_sequences",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_code_sequences_TenantId_CodeType",
                table: "code_sequences",
                columns: new[] { "TenantId", "CodeType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sku_import_rows_DeletedAt",
                table: "sku_import_rows",
                column: "DeletedAt");

            migrationBuilder.CreateIndex(
                name: "IX_sku_import_rows_ImportSessionId",
                table: "sku_import_rows",
                column: "ImportSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_sku_import_rows_IsDeleted",
                table: "sku_import_rows",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_sku_import_rows_TenantId",
                table: "sku_import_rows",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_sku_import_sessions_DeletedAt",
                table: "sku_import_sessions",
                column: "DeletedAt");

            migrationBuilder.CreateIndex(
                name: "IX_sku_import_sessions_IsDeleted",
                table: "sku_import_sessions",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_sku_import_sessions_TenantId",
                table: "sku_import_sessions",
                column: "TenantId");
